...
#include <memory>
#include "../../finalProject/progressBarThread.h"
...
void ProgressBarThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProgressBarThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ProgressBarThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressBarThread::resultReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ProgressBarThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_ProgressBarThread.data,
    qt_meta_data_ProgressBarThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ProgressBarThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProgressBarThread.stringdata0))
...
// SIGNAL 0
void ProgressBarThread::resultReady(const QString & _t1)
{
